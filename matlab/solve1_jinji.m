...
% original_solution = [0   163   114     8   309   305   123    45   160   191    92    93    61   292   326]; % 附件2最优初始解
    ...
    %         after_index = tc_index + 1;
        ...
        %     替换并评价解的好坏
            ...
            for i = 1:size(changeable, 2)
                ...
                p = rand();
                if ((temp_score < best_score || (p < (max_iter - it) * 2e-4)) && run3(data3, a1, a2, b1, b2, theta, delta, temp_solution))
