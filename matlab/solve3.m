...
%     disp(all_best_solution);
    r = calculate_success_rate(data3, all_best_solution, a1, a2, b1, b2, theta, delta);
    d = calculate_solution_detail(data3, all_best_solution, a1, a2, b1, b2, theta, delta);

    if (r > history_best_rate || d.length + 1e5 / r < history_best_score)
        history_best_rate = r;
        history_best_score = d.length + 1e5 / r;
        disp(all_best_solution);
        disp(r);
